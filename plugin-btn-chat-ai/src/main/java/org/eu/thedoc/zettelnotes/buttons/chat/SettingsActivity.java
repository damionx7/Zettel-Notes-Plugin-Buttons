...
public class SettingsActivity
  ...
  public static class SettingsFragment
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
      ...
      String model = mSharedPreferences.getString(getString(R.string.prefs_api_model_key), getString(R.string.model_gpt_5_1));
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
      ...
      if (key.equals(getString(R.string.prefs_api_model_key))) {
        String model = mSharedPreferences.getString(key, getString(R.string.model_gpt_5_1));
        mCustomModelPreference.setEnabled(model.equals(getString(R.string.model_custom)));
      }
    }
  }
